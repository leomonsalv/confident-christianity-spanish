...
export const MODULES_DATA: ModuleItem[] = [
  {
    ...
    "whatDrPeterPresents": "Una cosmovisión (del alemán Weltanschauung) es el modo particular de percibir e interpretar el mundo: un conjunto de creencias sobre la vida y el universo. Todo el mundo tiene una, sea consciente de ello o no. Funciona como un par de anteojos: uno no mira hacia ellos, mira a través de ellos.\n\nLa imagen central es la del iceberg: lo que vemos en la otra persona es su conducta (una décima parte, sobre la línea del agua). Debajo están sus valores, debajo de estos sus creencias, y en la base sus presuposiciones sobre la naturaleza del universo. Quien discute solo la conducta está discutiendo únicamente con la punta.\n\nSeis preguntas fundamentales descubren una cosmovisión:\n• ¿Qué es Dios? (teología)\n• ¿Qué son los seres humanos? (antropología)\n• ¿Cuál es la mejor forma de descubrir la verdad? (epistemología)\n• ¿Por qué tienen valor los seres humanos? (valores)\n• ¿Cómo decidimos lo que está bien y lo que está mal? (ética)\n• ¿Qué le sucede a una persona después de la muerte?\n\nCuatro grandes cosmovisiones compiten en la actualidad: panteísmo (hinduismo, budismo, Nueva Era), politeísmo (religiones tribales, animismo, religiones populares), teísmo (islam, judaísmo, cristianismo) y ateísmo (naturalismo, existencialismo, nihilismo). A continuación se ilustra su distribución estadística:",
  ...
  },
  {
    ...
    "whatDrPeterPresents": "Él estrecha la pregunta a propósito: no qué tiene de bueno el cristianismo, sino qué elementos de la cosmovisión cristiana son distintivos. Descarta las respuestas sobre el carácter y el fruto del Espíritu: importantes, pero no distintivas.\n\nSeis marcas esenciales:\n• La autoridad de la Biblia\n• La deidad de Cristo y la Trinidad\n• Cristo como el único camino de salvación\n• Su muerte física y resurrección corporal\n• La centralidad de la cruz (su muerte sustitutiva)\n• La salvación por gracia, mediante arrepentimiento y fe\n\nEl cuaderno reduce esas seis marcas a tres afirmaciones distintivas con las que ninguna otra religión está de acuerdo. Negar cualquiera de ellas es negar el cristianismo:\n\nLa deidad de Cristo se declara directamente en al menos ocho pasajes del Nuevo Testamento (Jn 1:1-2; 1:18; 20:28; Hch 20:28; Rom 9:5; Tit 2:13; Heb 1:8; 2 P 1:1) y está fuertemente implícita en otros (Mt 1:23; Jn 17:3, 5; Col 2:2; 2 Tes 1:12; 1 Tim 1:17; Stg 1:1; 1 Jn 5:20).\n\nLa ilustración de cierre es la de los billetes falsos: otras religiones y sectas subcristianas funcionan como falsificaciones eficaces porque se parecen mucho a lo auténtico. Medidas contra estas marcas distintivas, casi todas fallan en los criterios esenciales.",
  ...
  },
  {
    ...
    "whatDrPeterPresents": "Pasa rápido por las presuposiciones: todos necesitan el evangelio, incluidos los temerosos de Dios aún no convertidos (el centurión de Hch 10); Jesús es el único camino, mediante Su muerte en la cruz (Jn 14:6; Hch 4:12; 1 Tim 2:5); y damos testimonio porque el amor y el gozo de Dios nos impulsan (2 Cor 5:14; Heb 12:2).\n\nEl centro del módulo es la escala de Engel, que va de -10 (conciencia de lo sobrenatural) a 0 (regeneración). La escala completa está detallada en la Parte D.3.\n\nLa tabla de eficacia responde a la pregunta crucial: «¿Cómo llegó usted a Cristo?», contrastando la enorme efectividad de las relaciones familiares y de amistad (75-85 %) frente a otros medios formales:\n\nCierra con las cuatro fases esenciales:\n• Cultivar (preparar el suelo — habla al corazón)\n• Sembrar (plantar la Palabra — habla a la mente)\n• Cosechar (la decisión de seguir a Cristo — habla a la voluntad)\n• Multiplicar (crecer en el señorío de Cristo — habla a la persona entera)\n\nAfirma explícitamente que este curso trata de sembrar, no de cosechar.\n\n«Nuestra tarea es sembrar la semilla, y dejar que Aquel que nutre la semilla escondida la haga fructificar a su debido tiempo.»",
  ...
  },
  {
    ...
    "whatDrPeterPresents": "El cuaderno abre con una frase que conviene leer tal cual: «¡Hablar abiertamente de su fe en Dios puede dar miedo!»\n\nLos tres temores más comunes:\n• Perder amigos: «¡Sí, es un riesgo! Ser discípulo es algo costoso». Pero en la práctica, si tratamos a los demás con mansedumbre y respeto (1 P 3:15-16), rara vez nos dan la espalda.\n• Parecer una persona que juzga: surge de la falsa ecuación «ser bueno = ser cristiano». Si usted insinúa que es cristiano y ellos no, entienden que se está diciendo mejor que ellos. Eso pone el evangelio de cabeza.\n• No saber responder a sus preguntas: sobre esto no hay excusa porque «¡las cosas comunes ocurren comúnmente!». Si usted no ha pensado a fondo estas preguntas, «merece que le dé un sudor frío cada vez que comparte su fe».\n\nA continuación, se contrasta lo que las personas realmente piensan (Encuesta británica de Paul Weston) frente a las objeciones que los cristianos temen enfrentar (las preguntas de Paul Little):\n\nLa observación que el cuaderno guarda para el final: la verdadera razón por la que las personas no siguen a Cristo no es intelectual, sino moral: no están dispuestas a arrepentirse. Pero antes de que puedan verlo con claridad, hay que despejar eficazmente los escombros intelectuales.",
  ...
  },
  {
    ...
    "whatDrPeterPresents": "El cuaderno llama a esto la pregunta básica: «¿Por qué cree USTED en Dios?» y ofrece tres enfoques válidos:\n• La belleza y el diseño en el orden natural (Sal 19:1; Rom 1:19-20)\n• La conciencia interior (Hch 17:27; Rom 2:15)\n• Dios se ha revelado en Jesucristo (Col 1:13-15)\n\nY a continuación, el punto estratégico del módulo: tres conjuntos diferentes de objeciones según el enfoque que usted elija poner en la agenda:\n\nEl cuaderno lo dice con precisión: tarde o temprano, cualquier conversación sobre la fe cristiana implicará alguna discusión sobre la naturaleza de los documentos del Nuevo Testamento —«aquí está el punto de fondo de la apologética»—. Pero si usted responde a la pregunta básica usando los enfoques (1) o (2), es usted, el evangelista, quien ha puesto esos otros temas secundarios en la agenda de la conversación.\n\n«¿La respuesta básica? Vaya al corazón del evangelio: ¡hable de Jesús!»",
    ...
    "visualData": {
      "type": "table",
      "title": "Los Tres Enfoques y sus Objeciones Típicas",
      "headers": [
        "Enfoque Inicial",
        "Objeciones que suele provocar",
        "Riesgo Estratégico"
      ],
      "rows": [
        [
          "1. La creación",
          "Génesis vs. evolución; el problema del sufrimiento y del dolor",
          "Desvía hacia discusiones científicas/filosóficas estériles"
        ],
        [
          "2. La experiencia",
          "¿No es todo psicológico?; religiones del mundo; relativismo moral",
          "Se estanca en el subjetivismo y la relatividad de opiniones"
        ],
        [
          "3. Jesucristo",
          "La fiabilidad histórica del Nuevo Testamento y la resurrección",
          "¡Enfoque recomendado! Conduce directamente al corazón del evangelio"
        ]
      ]
    }
  },
  {
    ...
    "whatDrPeterPresents": "El modelo apostólico en tres movimientos esenciales:\n• Identificar: encontrar algo en lo que estén de acuerdo (Hch 13:13-51; 14:14-18; 17:22-31)\n• Confrontar: desafiar las creencias erróneas e inconsistencias lógicas (Hch 17:17; 13:46; 18:28; 19:8-9; 2 Cor 5:11; 10:5)\n• Invitar: presentar la verdad cristiana de Cristo crucificado y resucitado (Rom 1:16; 15:20; 1 Cor 1:23)\n\nEsto es lo que el cuaderno llama contextualización, y lo ilustra con el apóstol Pablo: en la sinagoga estableció un terreno común con un público judío comenzando por la historia bíblica; con la gente del campo en Listra habló de las lluvias y estaciones; con los filósofos de Atenas citó su propia poesía.\n\n«Jesús es el único camino hacia Dios, pero hay muchos caminos hacia Jesús.»\n\nEl modelo «submarino»: hacer preguntas en vez de afirmaciones tajantes; evitar la jerga cristiana; empezar siempre por los puntos de acuerdo (buscar «señales de verdad»); avanzar gradualmente hacia los desacuerdos; mostrar inconsistencias con delicadeza; pedir permiso para compartir; y presentar el evangelio de forma adecuada a la persona.",
